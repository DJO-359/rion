    ...
    <section className="py-10 md:py-14">
      <Container>
        <div className="flex flex-col gap-5 lg:flex-row lg:gap-6">
          <Link
            href="/products"
            className="group relative flex min-h-[280px] shrink-0 overflow-hidden rounded-[24px] bg-[#181d29] shadow-[var(--shadow-soft)] sm:min-h-[320px] lg:w-[240px] xl:w-[260px]"
          >
            <img
              src={promoSrc}
              alt="Сочные скидки"
            ...
            />
            {/* <div className="absolute inset-0 bg-[#181d29]/75" /> */}
